...
dew.on("show", function(e){
    if(settingsArray['Game.SkipTitleSplash'] == 1){
        ...
        $("#blackLayer").hide();
        $.getJSON( "https://raw.githubusercontent.com/duckfudge/ElDewrito-QOL-Patch/main/currentRelease.json", function(data) {
        ...
        dew.command('Game.FirstRun', {}).then(function(result){
            if(result == 1){
                $.getJSON("https://raw.githubusercontent.com/duckfudge/ElDewrito-QOL-Patch/main/announcements.json", function(data) {
